...
const BookingSummary = ({ onBack, onSubmit, formData, serviceDetails }: BookingSummaryProps) => {
  const bookingFee = 49.00;
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-900 mt-1">{formData.address || 'No address provided'}</p>
                </div>
              </div>
              <button className="text-yellow-500 font-medium">Change</button>
            </div>
            ...
            <div className="bg-white rounded-lg">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900">{serviceDetails?.type || 'Service'}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900">{new Date(formData.startDate).toLocaleDateString('en-US', { day: '2-digit', month: 'short' })}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Notes</span>
                  <span className="text-gray-900">{formData.notes || 'NA'}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900 text-right max-w-[60%]">{serviceDetails?.details}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Monthly Worker Salary</span>
                  <span className="text-gray-900">₹{formData.totalAmount.toLocaleString()}/-</span>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <button className="text-yellow-500 font-medium">View Coupons</button>
              </div>
            ...
            <div className="space-y-4">
              <label className="flex items-start gap-2">
                ...
                <span className="text-sm text-gray-600">
                  I agree to the{' '}
                  <Link to="/terms" className="text-yellow-500">Terms And Conditions</Link>
                </span>
              </label>
